...
{
    /// <summary>
    /// The Gateway's own advisory lock key, distinct from Catalog's and Library's (ADR-0006).
    /// Sharing a key across services would make unrelated deployments queue behind each other.
    /// </summary>
    private const long MigrationLockKey = 8_233_071_003;
    ...
    /// <summary>
    /// Brings the Gateway's schema up to date, serialised across replicas. ADR-0005 puts services
    ...
    public static async Task MigrateAsync(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        var logger = scope.ServiceProvider.GetRequiredService<ILoggerFactory>()
            .CreateLogger(typeof(GatewaySchema));
